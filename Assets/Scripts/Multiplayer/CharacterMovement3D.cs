...
public class CharacterMovement3D : MonoBehaviour
{
    ...
    public bool IsSlowdown { get => _isSlowdown; }
    ...
    private bool _pressRollKey;

    public UnityEvent<string> OnUpdateCoinNum;
    public UnityEvent<string> OnUpdateStaffCoinNum;
    ...
    public void TryJump(bool value)
    {
        _pressJumpKey = value;
    }
    ...
    public void TryRoll(bool value)
    {
        _pressRollKey = value;
    }
    ...
    public void ChangeSpeed(float decreaseSpeed, int slowDownTime)
    {
        _isSlowdown = true;
        _defultSpeed = _speed;
        _speed -= decreaseSpeed;
        StartCoroutine(ResetSpeed(slowDownTime));
    }

    public void UpdateCoinNumber()
    {
        if (_playerInput.playerIndex == 1) OnUpdateCoinNum.Invoke("" + _coin);
        else if (_playerInput.playerIndex == 0) OnUpdateStaffCoinNum.Invoke("" + _coin);
    }
    ...
    private IEnumerator ResetSpeed(int slowDownTime)
    {
